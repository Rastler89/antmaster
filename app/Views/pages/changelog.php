        ...
        <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass-card p-6 md:p-8 hover:border-blue-500/30 transition-all">
                <div class="flex items-center justify-between mb-4">
                    <time class="text-[10px] font-black text-blue-400 uppercase tracking-widest">7 Abril, 2026</time>
                    <span class="px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-[10px] font-black border border-blue-500/20">v1.1.6</span>
                </div>
