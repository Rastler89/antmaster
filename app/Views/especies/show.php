<div class="max-w-4xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-6">
        ...
        <div class="w-full md:w-auto px-6 py-3 rounded-2xl border <?= $colorClass ?> flex flex-row md:flex-col items-center justify-between md:justify-center gap-2">
            <span class="text-[10px] uppercase font-black tracking-widest opacity-60">Dificultad</span>
            <span class="text-base md:text-lg font-black"><?= $especie['dificultad'] ?></span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="glass-card p-6 flex items-center gap-4 border-orange-500/20 group hover:bg-orange-500/5 transition-all">
            ...
            <div>
                <p class="text-[10px] uppercase font-black text-zinc-500 tracking-widest mb-0.5">Temperatura</p>
        ...
        <div class="glass-card p-6 flex items-center gap-4 border-blue-500/20 group hover:bg-blue-500/5 transition-all">
            ...
            <div>
                <p class="text-[10px] uppercase font-black text-zinc-500 tracking-widest mb-0.5">Humedad</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div class="glass-card p-4 border-white/5">
            <p class="text-[9px] uppercase font-black text-zinc-500 tracking-widest mb-1 italic">Crecimiento</p>
            <div class="flex items-center gap-2">
                <span class="text-emerald-400 text-lg">⚡</span>
                <p class="text-sm font-semibold text-main"><?= htmlspecialchars($especie['velocidad_crecimiento'] ?: 'Sin datos') ?></p>
            </div>
        </div>
        <div class="glass-card p-4 border-white/5">
            <p class="text-[9px] uppercase font-black text-zinc-500 tracking-widest mb-1 italic">Tamaño</p>
            <div class="flex items-center gap-2">
                <span class="text-blue-400 text-lg">📏</span>
                <p class="text-sm font-semibold text-main"><?= htmlspecialchars($especie['tamano'] ?: 'Sin datos') ?></p>
            </div>
        </div>
        <div class="glass-card p-4 border-white/5">
            <p class="text-[9px] uppercase font-black text-zinc-500 tracking-widest mb-1 italic">Castas</p>
            <div class="flex items-center gap-2">
                <span class="text-purple-400 text-lg">👥</span>
                <p class="text-sm font-semibold text-main"><?= htmlspecialchars($especie['castas'] ?: 'Sin datos') ?></p>
            </div>
        </div>
        <div class="glass-card p-4 border-white/5">
            <p class="text-[9px] uppercase font-black text-zinc-500 tracking-widest mb-1 italic">Reproducción</p>
            <div class="flex items-center gap-2">
                <span class="text-pink-400 text-lg">👑</span>
                <p class="text-sm font-semibold text-main"><?= htmlspecialchars($especie['reproduccion'] ?: 'Sin datos') ?></p>
            </div>
        </div>
        <div class="glass-card p-4 border-white/5">
            <p class="text-[9px] uppercase font-black text-zinc-500 tracking-widest mb-1 italic">Localización</p>
            <div class="flex items-center gap-2">
                <span class="text-orange-400 text-lg">🌍</span>
                <p class="text-sm font-semibold text-main"><?= htmlspecialchars($especie['localizacion'] ?: 'Sin datos') ?></p>
            </div>
        </div>
        <div class="glass-card p-4 border-white/5">
            <p class="text-[9px] uppercase font-black text-zinc-500 tracking-widest mb-1 italic">Vuelos Nupciales</p>
            <div class="flex items-center gap-2">
                <span class="text-yellow-400 text-lg">✈️</span>
                <p class="text-sm font-semibold text-main"><?= htmlspecialchars($especie['vuelos'] ?: 'Sin datos') ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-12 flex justify-center">
        <a href="<?= BASE_URL ?>/especies/editar/<?= $especie['id'] ?>" class="magic-btn px-10 py-4 flex items-center gap-3">
            ...
            Sugerir mejora para esta ficha
        </a>
    </div>
</div>
