...
-- Este archivo añade las tablas y columnas necesarias para el sistema social y de logros.
...
CREATE TABLE IF NOT EXISTS logros (
    ...
    descripcion TEXT,
    requisito_tipo VARCHAR(50) NOT NULL, -- 'diarios', 'colonias', 'fichas', 'stock', 'tiempo'
